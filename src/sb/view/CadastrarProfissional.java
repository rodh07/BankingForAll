...
public class CadastrarProfissional extends CabecalhoBancario implements
		WindowListener {
	...
	public CadastrarProfissional(final Integer idProfissional) {
		super();
		...
		btnConfirmar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (txtNome.getText().equals("")
					...
					JOptionPane.showMessageDialog(CadastrarProfissional.this,
